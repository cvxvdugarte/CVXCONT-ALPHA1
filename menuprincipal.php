...
<title>CVXCONT</title>
  ...
  <body class="bodyblack">
    ...
    <div class="btn-group-vertical btn-group-xs">
      <button type="button" class="btn btn-primary" role="button"><a href="cxcregpers.php">REGISTRO DE PERSONAS</a></li>
      <button type="button" class="btn btn-primary" role="button"><a href="cxcregusr.php">REGISTRO DE USUARIOS</a></li>
      <button type="button" class="btn btn-primary"><a href="cxcregprov.php">REGISTRO DE PROVEEDORES</a></li>
      <!--CXC-->
         <button type="button" class="btn btn-primary" role="button"><a href="cxcregfac.php">REGISTRO DE FACTURAS</a></button>
         <button type="button" class="btn btn-primary" role="button"><a href="cxcregant.php">REGISTRO DE ANTICIPOS</a></button>
         <button type="button" class="btn btn-primary" role="button"><a href="cxcregcruce.php">REGISTRO DE CRUCES</a></button>
         <button type="button" class="btn btn-primary"><a href="cxcreport.php">REPORTES</a></button>
   <!--CXP-->
         <button type="button" class="btn btn-primary" role="button"><a href="cxpregfac.php">REGISTRO DE FACTURAS</a></button>
         <button type="button" class="btn btn-primary" role="button"><a href="cxpregant.php">REGISTRO DE ANTICIPOS</a></button>
         <button type="button" class="btn btn-primary" role="button"><a href="cxpregcruce.php">REGISTRO DE CRUCES</a></button>
